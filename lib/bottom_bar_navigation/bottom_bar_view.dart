...
import 'package:reggae_fitness_studio/inbox/inbox_page.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:math' as math;

import '../class/create_class_page.dart';
                    ...
                    child: ScaleTransition(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: ReggaeFitnessTheme.nearlyDarkBlue,
                          shape: BoxShape.circle,
                          boxShadow: <BoxShadow>[
                            BoxShadow(
                                color: ReggaeFitnessTheme.nearlyDarkBlue.withOpacity(0.4),
                                offset: const Offset(1.0, 16.0),
                                blurRadius: 16.0
                            ),
                          ],
                        ),
